...
##### Our research question is "What are some common characteristics for billionaires?". The assumptions include that most billionaires' wealth is inherited and they are mainly male. The data we use has a quantitative response variable of Net.Worth.Billion and several quantitative and categorical predictors including Age, Sector and Industry. Using various regression methods, we were able to find different characteristics for billionaires with different age and geographic citizenships. 
